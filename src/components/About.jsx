          ...
          <div className="about-desc">
            ...
            <div className="pt-5">
              ...
              <ul className="flex items-center space-x-4 mt-4">
                <li>
                  <a target="_blank" rel="noopener noreferrer" href="mailto:tahulkpktd@gmail.com">
                  <HiOutlineMail className="w-6 h-6" />                 </a>
                </li>
                <li>
                  <a target="_blank" rel="noopener noreferrer" href="https://github.com/rahulktd">
                  <FaGithub className="w-6 h-6" />
                                    </a>
                </li>
                <li>
                  <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/rahul-k-p-9aaa32236/">
                  <FaLinkedin className="w-6 h-6" />                  </a>
                </li>
                <li>
                  <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/rahul_1_8">
